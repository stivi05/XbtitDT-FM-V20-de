...
<if:IS_DISPLAYED_2>
<table width="100%" height="150" cellpadding="0" cellspacing="0" border="0" align="center">
  <tr>
		<td align="left"><img src="style/BloodZone/images/header_left.gif" width="200" height="150" /></td>
		<td align="center" width="100%" height="150" background="style/BloodZone/images/header_back.gif"></td>
		<td align="right"><img src="style/BloodZone/images/header_03.gif" width="499" height="150" /></td>
	</tr>
</table>	
<table width="100%" height="50" cellpadding="0" cellspacing="0" border="0" align="center">
  <tr>
		<td align="left"><img src="style/BloodZone/images/header_07.gif" width="46" height="50" /></td>
		<td align="center" width="100%" height="50" background="style/BloodZone/images/header_nav.gif"></td> 
		<td align="right"><img src="style/BloodZone/images/header_18.gif" width="46" height="50" /></td>
	</tr>
</table>
   <if:HAS_AT>   
<br /> <center>  <tag:advertop /> </center>  
  </if:HAS_AT>   
<div id="dropdown"><tag:main_dropdown /></div>
		
<div id="slideIt"><if:guestt><tag:main_slideIt />
<div class="slide_spacer"></div></if:guestt>

    <div id="header"><tag:main_header /></div>
  </div>
<div id="bodyarea">  
<table border="0" align="center" cellpadding="0" cellspacing="0" width="100%">
      <tr>
        ...
        <if:HAS_LEFT_COL>
        <if:HAS_LEFT>
        <td valign="top" id="rcol" width="190"><tag:main_left /></td>
        <td valign="top" width="5" rowspan="2"></td>
        </if:HAS_LEFT_COL>
        </if:HAS_LEFT>
        ...
        <if:HAS_RIGHT>
        <td valign="top" width="5" rowspan="2"></td>
        <td valign="top" id="rcol" width="190"><tag:main_right /></td>
        </if:HAS_RIGHT_COL>
        </if:HAS_RIGHT>
        <td valign="top" width="5" rowspan="2"></td>
      </tr>
