...
<form method="post" onsubmit="return form_control()" action="<tag:login.action />">
    ...
    <if:FB>
      <tr>
      <td class="lista" colspan="2" style="text-align:center; ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript: void(0);" onclick="window.location ='index.php?page=facebooklogin' "><img src="images/fbconnect.png" border=0></a></td>
    </tr>
    </if:FB>
    <tr>
