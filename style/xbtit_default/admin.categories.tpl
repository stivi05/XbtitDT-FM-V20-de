  ...
  <form name="category_add_new" action="<tag:frm_action />" method="post">
    <table class="lista">
      ...
      <tr>
        ...
        <tr>
        <td class="header">Porn Category ?</td>
        <td class="lista" > <input name="category_porn" type="radio" value="no" <tag:nop /> /> No <input name="category_porn" type="radio" value="yes" <tag:yep /> /> Yes </td>
      </tr>
      <tr>
...
<else:permedit>
  <table class="lista" width="100%" align="center" colspan ="6">
  <tr>
    ...
    <td class="header" align="center">Porn</td>
  ...
  <tr>
  	<td colspan="7">
  	<ul id='categories_list' style="float:left; width:100%; list-style-type:none; cursor:move; padding:0px; margin:0px;">
  	 <loop:categories>
	  	 <li id='categories_<tag:categories[].id />' style="float:left; width:100%; clear:both; border:1px dashed #cddae3" onmouseover="this.style.background='#cddae3'" onmouseout="this.style.background=''" onclick="ID.id=this.id;">
	  	 	<span class='lista' style="float:left; width:21%"><tag:categories[].sort_index /></span>
    <span style="float:left; width:12%"><tag:categories[].name /></span>
    <span style="float:left; width:14%"><tag:categories[].porn /></span>
    <span style="float:left; width:24%"><tag:categories[].image /></span>
    <span style="float:left; width:15%"><tag:categories[].perm /></span>
    <span style="float:left; width:8%"><tag:categories[].edit /></span>
    <span style="float:left; width:4%"><tag:categories[].delete /></span>
	  	 </li>
  	 </loop:categories>
  	 </ul>
  	</td>
