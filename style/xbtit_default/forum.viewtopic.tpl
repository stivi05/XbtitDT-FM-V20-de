<table width="100%">
  <tr>
    <td class="header"><a name="top" /><tag:topic_title /></td><td class="header" align = "right"><tag:usersontopic /></td>
  </tr>
</table>
  ...
  <tr>
    ...
    <loop:posts>
          ...
          <!-- poster infos -->
            <table width="140">
              <tr>
                ...
                <br />
        <if:forum_reputation>
        Reputation: <tag:posts[].reputation />
        <br />
        <else:forum_reputation>
        </if:forum_reputation>
      ...
      <img src="images/arany.png">&nbsp;<tag:posts[].ratio />
                ...
                <br />
                <tag:posts[].flag />&nbsp;&nbsp;&nbsp;<tag:posts[].online />&nbsp;
                </td>
              </tr>
            </table>
          </td>
