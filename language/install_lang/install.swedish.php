...
$install_lang["welcome"]                = "Välkommen till installationen för nya DT FM V20.0 DE";
...
$install_lang["system_req"]             = "<p>".$GLOBALS["btit-tracker"]."&nbsp;".$GLOBALS["current_btit_version"]." kräver PHP 5.0 eller bättre och en MYSQL databas.</p>";
...
$install_lang["succes_install3"]        = "<p>Vi på DT FM hoppas du gillar denna tracker och att vi ses på BTIT <a href=\"http://www.diemthuy.nl\" target=\"_blank\">forumet</a>.</p>";
