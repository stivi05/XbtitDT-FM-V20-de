...
$install_lang["welcome"]                = "Bienvenue dans l'installation guid&eacute;e de DT FM V20.0 DE";
...
$install_lang["system_req"]             = "<p>".$GLOBALS["btit-tracker"]."&nbsp;".$GLOBALS["current_btit_version"]." a besoin de PHP 5.0 ou plus et d'une base de donn&eacute;es MYSQL.</p>";
...
$install_lang["succes_install3"]        = "<p>L'&eacute;quipe DT FM vous souhaite une agr&eacute;able utilisation du produit, et esp&egrave;re vous voir bientot sur le <a href=\"http://www.diemthuy.nl\" target=\"_blank\">forum</a>.</p>";
