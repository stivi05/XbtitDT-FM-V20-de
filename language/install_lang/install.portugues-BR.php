...
//
//    Este arquivo é parte do xbtit DT FM.
//
...
$install_lang["welcome"]                = "Bem-vindo à instalação do novo DT FM V20.0 DE";
...
$install_lang["system_req"]             = "<p>".$GLOBALS["btit-tracker"]."&nbsp;".$GLOBALS["current_btit_version"]." Requer PHP 5.0 ou superior e um banco de dados MYSQL.</p>";
...
$install_lang["succes_upgrade3"]        = "<p>Nós esperamos que você aprecie (DT FM team) o uso deste produto e que iremos ver você novamente em nosso <a href=\"http://www.diemthuy.nl\" target=\"_blank\">fórum</a>.</p>";
