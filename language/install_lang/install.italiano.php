...
$install_lang["welcome"]                = "Benvenuto nell'installazione del nuovo DT FM V20.0 DE";
...
$install_lang["system_req"]             = "<p>".$GLOBALS["btit-tracker"]."&nbsp;".$GLOBALS["current_btit_version"]." richiede PHP 5.0 o superiore ed un database MySQL.</p>";
...
$install_lang["succes_install3"]        = "<p>Noi del DT FM team speriamo che usufruirai di questo prodotto, e che ci rivedremo di nuovo nel nostro <a href=\"http://www.diemthuy.nl\" target=\"_blank\">forum</a>.</p>";
