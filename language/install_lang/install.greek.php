...
//
//    Αυτό το αρχείο είναι μέρος του xBtit DT FM.
//
...
$install_lang["welcome"]                = "Καλώς ήρθατε στο installation για το νέο DT FM V20.0 DE";
...
$install_lang["system_req"]             = "<p>".$GLOBALS["btit-tracker"]."&nbsp;".$GLOBALS["current_btit_version"]." Χρειάζεται PHP 5.0 ή καλύτερο και μια MYSQL βάση δεδομένων.</p>";
...
$install_lang["succes_upgrade3"]        = "<p>WΗ ομάδα του DT FM ελπίζει να απολάυσετε τη χρησιμοποιήση αυτού του προιόντος και να σας δούμε <ahref=\"http://www.diemthuy.nl\" target=\"_blank\">forum</a>.</p>";
