...
$install_lang["system_req"]             = "<p>O ".$GLOBALS["btit-tracker"]."&nbsp;".$GLOBALS["current_btit_version"]." requer o PHP 5.0 ou superior e uma base de dados MYSQL.</p>";
...
$install_lang["succes_upgrade3"]        = "<p>Esperamos (DT FM team) que aprecie o uso deste produto e esperamos vê-lo novamente no nosso <a href=\"http://www.diemthuy.nl\" target=\"_blank\">fórum</a>.</p>";
