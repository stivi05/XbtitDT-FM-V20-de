...
$install_lang["welcome"]                = "Dobrodosli u instalaciju vaseg novog DT FM V20.0 DE";
...
$install_lang["system_req"]             = "<p>".$GLOBALS["btit-tracker"]."&nbsp;".$GLOBALS["current_btit_version"]." zahtijeva PHP 5.0 pa na vise i MYSQL bazu podataka.</p>";
...
$install_lang["succes_upgrade3"]        = "<p>Mi iz DT FM se nadamo da ce te uzivati u nasem proizvodu i da vas vidimo nasem oficijalnom forumu <a href=\"http://www.diemthuy.nl\" target=\"_blank\">BTIT Forum</a>.</p>";
