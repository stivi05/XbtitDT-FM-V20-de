...
var GetChaturl = "ajaxchat/getPChatData.php";
var SendChaturl = "ajaxchat/sendPChatData.php";
...
//pops out private history window
function PopPhistory() {
         newWin=window.open('index.php?page=allPshout','shouthistory','height=500,width=490,resizable=yes,scrollbars=yes');
...
function handlehHttpReceiveChat() {
  ...
  if (httpReceiveChat.readyState == 4) {
     ...
     var results = document.getElementById("outputPList");
...
function sendComment() {
    ...
    if (currentChatText != '') {
        ...
        currenttoid = document.forms['chatForm'].elements['toid'].value;
		currentP = document.forms['chatForm'].elements['pchat'].value;
		param = 'n='+ currentName+'&c='+ currentChatText+'&u='+ currentUid+'&t='+ currenttoid+'&p='+ currentP; 
