...
function handlehHttpSendChat(){if(httpSendChat.readyState==4){
var wrapper = document.getElementById('wrapper');
wrapper.innerHTML = '<OBJECT CLASSID="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="0" HEIGHT="0" CODEBASE="http://active.macromedia.com/flash5/cabs/swflash.cab#version=5,0,0,0"><PARAM NAME="MOVIE" VALUE="ajaxchat/sound/sound.swf"><PARAM NAME="PLAY" VALUE="true"><PARAM NAME="QUALITY" VALUE="best"><PARAM NAME="LOOP" VALUE="false"><EMBED SRC="ajaxchat/sound/sound.swf" WIDTH="0" HEIGHT="0" PLAY="true" LOOP="false" QUALITY="best" PLUGINSPAGE="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash"></EMBED></OBJECT>';
receiveChatText();}}
