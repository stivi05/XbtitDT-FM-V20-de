...
<table border="0" width="100%" class="lista">
  ...
  <tr valign="top">
		...
		<td class="lista"><tag:ucp.profile_status /><br/><small>added: <tag:ucp.status_time /></small></td>
	</tr>
   <tr>
...
<tr>
    ...
    <td class="lista" colspan="2" align="left"><tag:ucp.emailnot /></td>
      ...
      <tr>
    <td class="header" align="left">Invisible for other users:</td>
    <td class="lista" colspan="2" align="left"><tag:ucp.invisible /></td>
  </tr>
  
        <tr>
    <td class="header" align="left">Private Profile:</td>
    <td class="lista" colspan="2" align="left"><tag:private /></td>
  </tr>
  
      <tr>
    <td class="header" align="left">Show Porn:</td>
...
<tr>
  ...
  <td class="lista" colspan="2"><tag:ucp.seedbonus />&nbsp;<a href=index.php?page=bonustransfer><font color=orangered>[Donate Bonus Points]</font></a></td>
</tr>
  <tr>
    <td class="header" align="left"><tag:language.USERBAR />:</td>
    <td class="lista" colspan="2" align="left"><tag:ucp.userbar /></td>
  </tr>
<if:INTERNAL_FORUM>
  <tr>
  ...
  <tr>
    <td class="header" align="left"><tag:language.WATCHED />:</td>
    <td class="lista" colspan="2" align="left"><tag:watchtopic /></td>
  </tr>
</if:INTERNAL_FORUM>
</table>
<tag:pagertop />
