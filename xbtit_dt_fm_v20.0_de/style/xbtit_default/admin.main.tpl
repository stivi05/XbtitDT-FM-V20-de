     ...
     <table border="0" class="lista" align="center" width="100%">
      <tr>
       <td valign="top">
           ...
           Please wait while Trying to fetch latest news/version from <a href="http://www.xbtitdeveloping.org">XBTIT Developing</a>
           <br />
  ...
  <td valign="top" width="250"><br />
    <table border="0" class="lista" align="center" width="100%">
           ...
           <tr><td class="blocklist"><tag:admin.infos /></td></tr>
            <tr><td class="blocklist" align="center"> <a href="http://www.websitecustomizers.net" target="_blank"><img src="images/v16.png" /></a></td></tr>
    </table>
  </td>
  </tr>
</table>
