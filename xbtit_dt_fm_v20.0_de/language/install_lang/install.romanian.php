...
$install_lang["welcome"]                = "Bun-venit la instalarea noului DT FM V20.0 DE";
...
$install_lang["system_req"]             = "<p>".$GLOBALS["btit-tracker"]."&nbsp;".$GLOBALS["current_btit_version"]." necesită PHP versiunea 5.0 sau mai mare şi o bază de date MySQL.</p>";
...
$install_lang["succes_install3"]        = "<p>Echipa DT FM speră că vei utiliza cu încredere acest produs şi că ne vom revedea cât de curând pe <a href=\"http://www.diemthuy.nl\" target=\"_blank\">forumul nostru</a>.</p>";
